# Session 2026-07-06-018

## Summary

Made Rust handoff instruction rows reuse context-filled suggested commands instead of generic placeholders.
...
- [x] Updated adm-cli tests to assert context-filled instruction commands.
- [x] Updated `RUST/README.md` to document that generated `instruction=` rows use the same context-filled suggested commands as blocker resolution rows.
